...
node_schemas = [
    NodeSchema("Person", ["lastName", "firstName", "fatherName"], "Represents an individual person"),
    NodeSchema("Address", ["cityName", "streetName", "streetNumber", "postalCode"],
               "Represents school's postal address"),
]

relationship_schemas = [
    RelationshipSchema("Person", "isPlacedInto", "Address", ["placementType"])
]
...
filepath = Path("pdfs") / "2.ΥΠΕΥΘΥΝΗ ΔΗΛΩΣΗ.pdf"
