...
node_schemas = [
    NodeSchema("OriginCity", ["cityName"], "Represents the from City"),
    NodeSchema("DestinationCity", ["cityName"], "Represents the to City"),
]

relationship_schemas = [
    RelationshipSchema("OriginCity", "hasDistanceTo", "DestinationCity", ["kilometers"])
]
...
filepath = Path("pdfs") / "4.Χιλιομετρική απόσταση.pdf"
output_file = Path("pdfs") / "graph_output4.txt"
